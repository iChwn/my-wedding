  ...
  const smQuery = useMediaQuery("only screen and (min-width: 700px)");
	...
	return (
		<div className='h-full w-full flex items-center justify-center flex-col'>
          ...
          <NormalOpening callback={transitionCallback} />
				</div>
									...
									<div className='w-full mt-5'>
										...
										<ol className="relative border-l border-gray-200 mt-5">
											...
											<li className="mb-10 ml-4">
													...
													<h3 className="text-lg font-semibold text-gray-900 dark:text-white">Awal kita mengenal secara online di Facebook grup Anime</h3>
