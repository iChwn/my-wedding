...
const BaseCountdown = ({days, hours, minutes, seconds, isCompleted}) => {
  return !isCompleted ? (
    <div className="flex flex-col items-center justify-center px-5 py-5">
      <span className="text-center font-merriweather text-md font-normal mb-7 px-5 text-[#272A33]">
      ...
      <div className="md:text-6xl text-3xl text-center flex w-full items-center justify-center">
        <Zoom duration={500}>
          <div className="md:w-24 w-20 mx-1 p-2 shadow-md text-[#566261] bg-[#fff]/[0.85] rounded-lg border-gray-500 border-2">
    ...
    <Zoom delay={500}>
      <span className="font-merriweather mt-2 text-3xl text-[#bba25f]">Acara Telah Berlangsung</span>
    </Zoom>
  )
}
